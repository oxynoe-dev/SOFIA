...
5. **Arbitrage PO** — le PO passe l'ADR à **Accepted** ou **Rejected**. La décision est tracée avec son contexte
...
- **Coder sur un ADR Proposed** — un ADR Proposed n'est pas une autorisation. Seul le statut Accepted autorise l'implémentation. Coder avant l'arbitrage PO, c'est investir du temps sur une décision qui peut être rejetée
