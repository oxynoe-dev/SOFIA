...
4. **Calibrage** — premiers échanges avec le PO et les personas adjacents. Ajustement de la posture, du vocabulaire, du niveau de détail. Le calibrage prend 2-3 sessions
...
| Persona | Rôle |
|---------|------|
| PO | Valide la nécessité, arbitre le périmètre |
