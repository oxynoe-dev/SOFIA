...
- The structure is ready for `provider/mistral/` in v0.5 without further restructuring
...
Proposal from Sofia (graphism session 2026-04-05) identifying the three levels: "Core — the invariants. Protocol — the interface contract. Provider — the concrete implementation." Validated and implemented by Mira, arbitrated by the orchestrator.
