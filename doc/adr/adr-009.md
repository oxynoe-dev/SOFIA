...
**1. Instance personas are not in the core.** Archetypes (architect, dev, strategist...) are reference models. Concrete instance personas (Mira, Axel, Marc...) are specific to the orchestrator. This is neither core, nor protocol, nor provider.
...
- `provider/claude-code/templates/` (empty — CLAUDE.md migrated)
